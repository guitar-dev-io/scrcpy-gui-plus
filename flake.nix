        ...
        packages.default = pkgs.rustPlatform.buildRustPackage {
          ...
          desktopItems = [
            (pkgs.makeDesktopItem {
              name = "scrcpy-gui-plus";
              exec = "scrcpy-gui-plus";
              icon = "scrcpy-gui-plus";
          ...
          postInstall = ''
            ...
            for size in 32 64 128; do
              install -Dm644 icons/''${size}x''${size}.png $out/share/icons/hicolor/''${size}x''${size}/apps/scrcpy-gui-plus.png
            done

            # Install high-resolution icons for GNOME/modern desktops
            install -Dm644 icons/128x128@2x.png $out/share/icons/hicolor/256x256/apps/scrcpy-gui-plus.png
            install -Dm644 icons/icon.png $out/share/icons/hicolor/512x512/apps/scrcpy-gui-plus.png

            # Install a fallback pixmap just in case
            install -Dm644 icons/icon.png $out/share/pixmaps/scrcpy-gui-plus.png
          '';
